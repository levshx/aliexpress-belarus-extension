function link_replace(url) {
    try {
      let result = url.replace("aliexpress.com", "aliexpress.ru");
      return result;
    }
    catch {
            ...
            if (changeInfo.status == "loading") {
              ...
              if (tab.url.includes("aliexpress.ru")) {
                ...
                if (data.country_currency == 0 || data.country_currency_mode) {
                  ...
                  try {
                    chrome.cookies.remove({ url: "https://www.aliexpress.ru", name: "aep_usuc_f" });
                    chrome.cookies.remove({ url: "https://wp.aliexpress.ru", name: "aep_usuc_f" });
